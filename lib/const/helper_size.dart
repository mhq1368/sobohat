...
//   static const double _baseWidth = 391; // آیفون 12 و پوکو X3 → عرض پایه
...
//     _scaleFactor = _screenWidth / _baseWidth;
//   }
...
//   /// سایز تطبیقی (مثلاً برای فونت)
//   double scaledSize(double baseSize) => baseSize * _scaleFactor;

//   /// Radius تطبیقی
//   double scaledRadius(double baseRadius) => baseRadius * _scaleFactor;

//   /// سایز بنر تطبیقی
//   Size scaledBoxSize(double baseWidth, double baseHeight) =>
//       Size(baseWidth * _scaleFactor, baseHeight * _scaleFactor);

//   /// فاصله (EdgeInsets) تطبیقی
//   EdgeInsets scaledPadding(double basePadding) =>
//       EdgeInsets.all(basePadding * _scaleFactor);

//   /// فاصله اختصاصی (top, left, right, bottom)
